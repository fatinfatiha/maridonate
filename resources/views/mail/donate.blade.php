						...
						<tr><td align="left" valign="middle">
							...
							<table width="115" border="0" cellspacing="0" cellpadding="0" >
								<tr><td align="left" valign="top" class="mob_center">
									...
									<!-- <img src="http://maridonate.localhost/images/logo2.png" width="115" height="19" alt="MARiDONATE" border="0" style="display: block;" /></font></a> -->
								</td></tr>
							</table>
						</td></tr>
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr><td align="center">
				<div style="line-height: 44px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
						Dear, <b style="text-transform:capitalize;">Admin</b>
					</span></font><br><br>
				</div>
				<div style="line-height: 24px;">
					<font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						We would like to inform you that <b style="text-transform:capitalize;">{{$firstname}} {{$lastname}}</b> have been donated to <b style="text-transform:capitalize;">{{$campaign}}</b> <br>
						The amount of the donation is <b style="text-transform:capitalize;">MYR{{$donation}}</b>.<br><br>

						Please find the attach below.<br><br>

            The total fund for this campaign is <b style="text-transform:capitalize;">MYR{{$totalFund}}</b><br><br>
						Thank You.<br><br>
			...
			<tr><td align="center">
				<div style="line-height: 24px;">
					<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
						<font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
							<!-- <img src="http://maridonate.localhost/images/logo2.png" width="193" height="43" alt="MARiDONATE" border="0" style="display: block;" /></font></a> -->
				</div>
				<!-- padding --><div style="height: 60px; line-height: 60px; font-size: 10px;"> </div>
			</td></tr>
		</table>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					2019 © MARiDONATE. ALL Rights Reserved.
				</span></font>
			</td></tr>
		</table>
