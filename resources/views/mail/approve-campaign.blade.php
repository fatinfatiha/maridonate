			...
			<tr><td align="center">
				...
				<div style="line-height: 24px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						Congratulations, your created campaign which is <b style="text-transform:capitalize;">{{$campaign}}</b> was approved by our Admin. <br>
						Do visit your campaign in our platform live. <br><br>
