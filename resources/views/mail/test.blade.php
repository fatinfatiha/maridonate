			...
			<tr><td align="center">
				<div style="line-height: 44px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
						Dear, <b style="text-transform:capitalize;">{{$firstname}} {{$lastname}}</b>
					</span></font><br><br>
				</div>
				<div style="line-height: 24px;">
					<font face="Arial, Helvetica, sans-serif" size="4" color="#57697e" style="font-size: 15px;">
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						We would like to inform you that your created campaign which is <b style="text-transform:capitalize;">{{$campaign}}</b> have been edited by our admin.<br>
						Do visit your campaign to view the updated version.<br><br>
