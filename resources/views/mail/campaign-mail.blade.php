			...
			<tr><td align="center">
				...
				<div style="line-height: 24px;">
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						We would like to inform you that <b style="text-transform:capitalize;">{{$firstname}} {{$lastname}}</b> have been created a new campaign which is <b style="text-transform:capitalize;">{{$campaign}}</b> <br>
						Please find the attach below and do visit admin dashboard for the campaign verification. <br><br>
