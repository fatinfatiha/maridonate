                   ...
                   <div class="">
                     ...
                     <div class="single-causes mb-30">
                         ...
                         <div class="causes-info">
                             ...
                             <form class="causes-meta" action="{{url('/backend/del-campaign-details')}}" method="post">
                               <!-- <a class="button theme-bg" href="{{url('/campaign-details')}}">View Details
                                 <input type="hidden" name="campaignID" value="{{$campaign->del_camp_id}}">
                               </a> -->

                               <form class="" action="{{url('/backend/del-campaign-details')}}" method="post">
